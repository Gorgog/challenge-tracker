      ...
      {tags.map((t) => (
        <li key={t.tag}>
          <details className="rounded-xl border border-border bg-card px-4 py-3">
            <summary className="grid cursor-pointer list-none grid-cols-[minmax(0,1fr)_auto] items-center gap-x-3 gap-y-0.5 [&::-webkit-details-marker]:hidden">
              ...
              <span className="col-span-2 text-[13px] leading-snug">
