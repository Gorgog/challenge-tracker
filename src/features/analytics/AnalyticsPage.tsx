      ...
      {loading ? (
        ...
        <>
          ...
          <p className="max-w-2xl text-[12px] leading-relaxed text-muted-foreground">
            ...
            быть совпадением. «Возможно» — ранний вывод: в первые недели он ошибается примерно через раз
            и с новыми днями либо крепнет до «похоже», либо пропадает. Разницы посчитаны с поправкой на
            выходные, на полосы хороших и плохих дней и на общий подъём или спад оценок.
          </p>
        </>
      )}
    </div>
