...
/**
 * Меньше стольких дней в группе — вывода нет: на таких выборках разница — шум,
 * и показывать её нечестно. Сами выводы считает `effects.ts`.
 */
export const MIN_GROUP = 10

/** Минимум дней с тегом, чтобы тег вообще появился в выводах. */
