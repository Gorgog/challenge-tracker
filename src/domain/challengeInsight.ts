 ...
 * Чисел влияния нет, пока при создании не спрашиваем «на что жду влияния». Отказы не сравниваются: «с / без» —
 * только для тегов и сна; у отказов — прогресс по дням с ответом «Да, без» или «сорвался» (срез 5а).
 */
